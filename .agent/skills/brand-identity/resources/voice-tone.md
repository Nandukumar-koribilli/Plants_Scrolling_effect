...
* **Headings:** Use Title Case for main headings (H1, H2). Use sentence case for subheadings
(H3+).
* **Punctuation:** Avoid exclamation points (!) in standard interface copy. Use periods for
complete sentences.
...
| :--- | :--- |
| "Utilize" | "Use" |
| "In order to..." | "To..." || [Add word] | [Add replacement] |